...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw[draw=black] (0,0) rectangle node {T1} ++(4,0.5);
    \draw[draw=black] (4,0) rectangle node {T2} ++(1,0.5);
  \end{tikzpicture}
\end{center}
%\end{figure}
...
\begin{center}
  ...
  \begin{tikzpicture}
    ...
    \draw[draw=black] (0,0) rectangle node {T1} ++(4,0.5);
    \draw[draw=black] (4,0) rectangle node {T2} ++(0.5,0.5);
  \end{tikzpicture}
\end{center}
